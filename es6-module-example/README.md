This is a simple static website that uses ES6 modules. You can use an npm package [http-server](https://www.npmjs.com/package/http-server) to host a static web server locally.
